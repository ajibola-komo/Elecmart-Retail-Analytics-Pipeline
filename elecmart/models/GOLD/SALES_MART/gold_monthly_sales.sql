select date_trunc('month', ft.transaction_timestamp) as transaction_month, 
...
group by transaction_month, transaction_month_id, store_id, sales_channel, transaction_status
